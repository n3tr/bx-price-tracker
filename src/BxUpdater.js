...
class BxUpdater {
  constructor() {
    this._updateInterval = store.get(STORE_KEYS.UPDATE_INTERVAL_KEY, DEFAULT_INTERVAL)
    this._latestTickers = store.get(STORE_KEYS.LATEST_TICKERS_KEY)
    this._lastUpdateDate = store.get(STORE_KEYS.LAST_UPDATE_DATE_KEY)
